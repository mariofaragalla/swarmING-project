...
// Common copy functions of server for mavros_msgs/ParamSetResponse
...
namespace ParamSet_Response {
  ...
  MDArray_T get_arr_mavros_msgs_ParamValue(MDFactory_T& factory, const mavros_msgs::ParamSet::Response::_value_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_mavros_msgs_ParamValue(mavros_msgs::ParamValue& val, const matlab::data::StructArray& arr) {
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(mavros_msgs::ParamSet::Response& msg, const matlab::data::StructArray arr) {
    try {
        //success
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const mavros_msgs::ParamSet::Response& msg) {
