...
// Common copy functions for mavros_msgs/ParamSetResponse
...
namespace ParamSetResponse {
  ...
  MDArray_T get_arr_mavros_msgs_ParamValue(MDFactory_T& factory, const mavros_msgs::ParamSetResponse::_value_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_mavros_msgs_ParamValue(mavros_msgs::ParamValue& val, const matlab::data::StructArray& arr) {
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<mavros_msgs::ParamSetResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //success
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const mavros_msgs::ParamSetResponse>& msg) {
