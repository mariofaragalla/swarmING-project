...
// Common copy functions of server for mavros_msgs/FileListResponse
...
namespace FileList_Response {
  ...
  MDArray_T get_arr_mavros_msgs_FileEntry_var_arr(MDFactory_T& factory, const mavros_msgs::FileList::Response::_list_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_mavros_msgs_FileEntry_var_arr(mavros_msgs::FileEntry& val, const matlab::data::Struct& arr) {
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(mavros_msgs::FileList::Response& msg, const matlab::data::StructArray arr) {
    try {
        //list
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const mavros_msgs::FileList::Response& msg) {
