...
// Common copy functions for mavros_msgs/FileOpenResponse
...
namespace FileOpenResponse {
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<mavros_msgs::FileOpenResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //size
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const mavros_msgs::FileOpenResponse>& msg) {
