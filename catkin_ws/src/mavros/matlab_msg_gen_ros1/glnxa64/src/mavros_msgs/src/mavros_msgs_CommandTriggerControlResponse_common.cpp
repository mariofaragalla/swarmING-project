...
// Common copy functions for mavros_msgs/CommandTriggerControlResponse
...
namespace CommandTriggerControlResponse {
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<mavros_msgs::CommandTriggerControlResponse>& msg, const matlab::data::StructArray arr) {
    try {
        //success
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const mavros_msgs::CommandTriggerControlResponse>& msg) {
