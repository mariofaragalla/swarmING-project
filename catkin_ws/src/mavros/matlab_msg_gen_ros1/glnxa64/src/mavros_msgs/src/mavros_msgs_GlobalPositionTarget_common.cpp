...
namespace GlobalPositionTarget {
  void copy_from_arr_std_msgs_Header(std_msgs::Header& val, const matlab::data::StructArray& arr);
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const mavros_msgs::GlobalPositionTarget::_header_type& val);
  ...
  MDArray_T get_arr_geometry_msgs_Vector3(MDFactory_T& factory, const mavros_msgs::GlobalPositionTarget::_velocity_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_std_msgs_Header(std_msgs::Header& val, const matlab::data::StructArray& arr) {
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<mavros_msgs::GlobalPositionTarget>& msg, const matlab::data::StructArray arr) {
    try {
        //header
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const mavros_msgs::GlobalPositionTarget>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","coordinate_frame","FRAME_GLOBAL_INT","FRAME_GLOBAL_REL_ALT","FRAME_GLOBAL_TERRAIN_ALT","type_mask","IGNORE_LATITUDE","IGNORE_LONGITUDE","IGNORE_ALTITUDE","IGNORE_VX","IGNORE_VY","IGNORE_VZ","IGNORE_AFX","IGNORE_AFY","IGNORE_AFZ","FORCE","IGNORE_YAW","IGNORE_YAW_RATE","latitude","longitude","altitude","velocity","acceleration_or_force","yaw","yaw_rate"});
    // header
    ...
    // IGNORE_LATITUDE
    outArray[0]["IGNORE_LATITUDE"] = factory.createScalar(static_cast<uint16_t>(msg->IGNORE_LATITUDE));
    // IGNORE_LONGITUDE
    outArray[0]["IGNORE_LONGITUDE"] = factory.createScalar(static_cast<uint16_t>(msg->IGNORE_LONGITUDE));
    // IGNORE_ALTITUDE
    outArray[0]["IGNORE_ALTITUDE"] = factory.createScalar(static_cast<uint16_t>(msg->IGNORE_ALTITUDE));
    // IGNORE_VX
