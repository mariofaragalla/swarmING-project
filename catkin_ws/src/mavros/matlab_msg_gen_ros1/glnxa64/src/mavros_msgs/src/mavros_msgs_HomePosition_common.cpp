...
namespace HomePosition {
  ...
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const mavros_msgs::HomePosition::_header_type& val);
  ...
  MDArray_T get_arr_geographic_msgs_GeoPoint(MDFactory_T& factory, const mavros_msgs::HomePosition::_geo_type& val);
  void copy_from_arr_geometry_msgs_Point(geometry_msgs::Point& val, const matlab::data::StructArray& arr);
  MDArray_T get_arr_geometry_msgs_Point(MDFactory_T& factory, const mavros_msgs::HomePosition::_position_type& val);
  void copy_from_arr_geometry_msgs_Quaternion(geometry_msgs::Quaternion& val, const matlab::data::StructArray& arr);
  MDArray_T get_arr_geometry_msgs_Quaternion(MDFactory_T& factory, const mavros_msgs::HomePosition::_orientation_type& val);
  void copy_from_arr_geometry_msgs_Vector3(geometry_msgs::Vector3& val, const matlab::data::StructArray& arr);
  MDArray_T get_arr_geometry_msgs_Vector3(MDFactory_T& factory, const mavros_msgs::HomePosition::_approach_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_std_msgs_Header(std_msgs::Header& val, const matlab::data::StructArray& arr) {
  ...
  void copy_from_arr_geometry_msgs_Vector3(geometry_msgs::Vector3& val, const matlab::data::StructArray& arr) {
    ...
    try {
        const matlab::data::TypedArray<double> _approachx_arr = arr[0]["x"];
        val.x = _approachx_arr[0];
    } catch (matlab::data::InvalidFieldNameException&) {
        throw std::invalid_argument("Field 'x' is missing.");
    } catch (matlab::data::TypeMismatchException&) {
        throw std::invalid_argument("Field 'x' is wrong type; expected a double.");
    ...
    try {
        const matlab::data::TypedArray<double> _approachy_arr = arr[0]["y"];
        val.y = _approachy_arr[0];
    } catch (matlab::data::InvalidFieldNameException&) {
        throw std::invalid_argument("Field 'y' is missing.");
    } catch (matlab::data::TypeMismatchException&) {
        throw std::invalid_argument("Field 'y' is wrong type; expected a double.");
    ...
    try {
        const matlab::data::TypedArray<double> _approachz_arr = arr[0]["z"];
        val.z = _approachz_arr[0];
    } catch (matlab::data::InvalidFieldNameException&) {
        throw std::invalid_argument("Field 'z' is missing.");
    } catch (matlab::data::TypeMismatchException&) {
        throw std::invalid_argument("Field 'z' is wrong type; expected a double.");
  ...
  //----------------------------------------------------------------------------
  MDArray_T get_arr_geometry_msgs_Vector3(MDFactory_T& factory, const mavros_msgs::HomePosition::_approach_type& val) {
    auto _approachoutArray = factory.createStructArray({1,1},{"x","y","z"});
    // _geometry_msgs_Vector3.x
    _approachoutArray[0]["x"] = factory.createScalar(val.x);
    // _geometry_msgs_Vector3.y
    _approachoutArray[0]["y"] = factory.createScalar(val.y);
    // _geometry_msgs_Vector3.z
    _approachoutArray[0]["z"] = factory.createScalar(val.z);
    return std::move(_approachoutArray);
  }
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<mavros_msgs::HomePosition>& msg, const matlab::data::StructArray arr) {
    try {
        //header
    ...
    try {
        //approach
        const matlab::data::StructArray approach_arr = arr[0]["approach"];
        copy_from_arr_geometry_msgs_Vector3(msg->approach,approach_arr);
    } catch (matlab::data::InvalidFieldNameException&) {
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const mavros_msgs::HomePosition>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","geo","position","orientation","approach"});
    // header
    ...
    // approach
    outArray[0]["approach"] = get_arr_geometry_msgs_Vector3(factory, msg->approach);
