...
namespace WaypointPull_Request {
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(mavros_msgs::WaypointPull::Request& msg, const matlab::data::StructArray arr) {
  }
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const mavros_msgs::WaypointPull::Request& msg) {
