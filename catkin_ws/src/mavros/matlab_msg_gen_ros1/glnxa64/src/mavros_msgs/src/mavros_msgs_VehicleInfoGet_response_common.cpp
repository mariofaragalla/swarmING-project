...
// Common copy functions of server for mavros_msgs/VehicleInfoGetResponse
...
namespace VehicleInfoGet_Response {
  ...
  MDArray_T get_arr_mavros_msgs_VehicleInfo_var_arr(MDFactory_T& factory, const mavros_msgs::VehicleInfoGet::Response::_vehicles_type& val);
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(mavros_msgs::VehicleInfoGet::Response& msg, const matlab::data::StructArray arr) {
    try {
        //success
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const mavros_msgs::VehicleInfoGet::Response& msg) {
