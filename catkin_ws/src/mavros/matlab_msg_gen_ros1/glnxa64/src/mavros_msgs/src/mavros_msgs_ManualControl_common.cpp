...
namespace ManualControl {
  ...
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const mavros_msgs::ManualControl::_header_type& val);
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<mavros_msgs::ManualControl>& msg, const matlab::data::StructArray arr) {
    try {
        //header
    ...
    try {
        //r
        const matlab::data::TypedArray<float> r_arr = arr[0]["r"];
        msg->r = r_arr[0];
    } catch (matlab::data::InvalidFieldNameException&) {
    ...
    try {
        //buttons
        const matlab::data::TypedArray<uint16_t> buttons_arr = arr[0]["buttons"];
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const mavros_msgs::ManualControl>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","x","y","z","r","buttons"});
    // header
    ...
    // r
    outArray[0]["r"] = factory.createScalar(msg->r);
    // buttons
    outArray[0]["buttons"] = factory.createScalar(msg->buttons);
