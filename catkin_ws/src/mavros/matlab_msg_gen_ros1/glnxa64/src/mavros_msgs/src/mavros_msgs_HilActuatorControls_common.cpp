...
namespace HilActuatorControls {
  void copy_from_arr_std_msgs_Header(std_msgs::Header& val, const matlab::data::StructArray& arr);
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const mavros_msgs::HilActuatorControls::_header_type& val);
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<mavros_msgs::HilActuatorControls>& msg, const matlab::data::StructArray arr) {
    try {
        //header
    ...
    try {
        //controls
        const matlab::data::TypedArray<float> controls_arr = arr[0]["controls"];
        size_t nelem = 16;
    ...
    try {
        //flags
        const matlab::data::TypedArray<uint64_t> flags_arr = arr[0]["flags"];
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const mavros_msgs::HilActuatorControls>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","controls","mode","flags"});
    // header
    outArray[0]["header"] = get_arr_std_msgs_Header(factory, msg->header);
    // controls
    outArray[0]["controls"] = factory.createArray<mavros_msgs::HilActuatorControls::_controls_type::const_iterator, float>({1, msg->controls.size()}, msg->controls.begin(), msg->controls.end());
    // mode
