...
// Common copy functions for mavros_msgs/RCOut
...
namespace RCOut {
  ...
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const mavros_msgs::RCOut::_header_type& val);
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<mavros_msgs::RCOut>& msg, const matlab::data::StructArray arr) {
    try {
        //header
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const mavros_msgs::RCOut>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","channels"});
    // header
    outArray[0]["header"] = get_arr_std_msgs_Header(factory, msg->header);
    // channels
    outArray[0]["channels"] = factory.createArray<mavros_msgs::RCOut::_channels_type::const_iterator, uint16_t>({1, msg->channels.size()}, msg->channels.begin(), msg->channels.end());
