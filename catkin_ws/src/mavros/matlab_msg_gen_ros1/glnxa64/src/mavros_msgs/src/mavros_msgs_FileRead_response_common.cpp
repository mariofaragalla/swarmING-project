...
// Common copy functions of server for mavros_msgs/FileReadResponse
...
namespace FileRead_Response {
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(mavros_msgs::FileRead::Response& msg, const matlab::data::StructArray arr) {
    try {
        //data
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const mavros_msgs::FileRead::Response& msg) {
    auto outArray = factory.createStructArray({1,1},{"data","success","r_errno"});
    // data
    outArray[0]["data"] = factory.createArray<mavros_msgs::FileRead::Response::_data_type::const_iterator, uint8_t>({1, msg.data.size()}, msg.data.begin(), msg.data.end());
    // success
