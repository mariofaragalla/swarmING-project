...
namespace WaypointPush_Request {
  ...
  MDArray_T get_arr_mavros_msgs_Waypoint_var_arr(MDFactory_T& factory, const mavros_msgs::WaypointPush::Request::_waypoints_type& val);
  //----------------------------------------------------------------------------
  void copy_from_arr_mavros_msgs_Waypoint_var_arr(mavros_msgs::Waypoint& val, const matlab::data::Struct& arr) {
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(mavros_msgs::WaypointPush::Request& msg, const matlab::data::StructArray arr) {
    try {
        //start_index
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const mavros_msgs::WaypointPush::Request& msg) {
