...
namespace CommandVtolTransitionRequest {
  ...
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const mavros_msgs::CommandVtolTransitionRequest::_header_type& val);
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<mavros_msgs::CommandVtolTransitionRequest>& msg, const matlab::data::StructArray arr) {
    try {
        //header
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const mavros_msgs::CommandVtolTransitionRequest>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","STATE_MC","STATE_FW","state"});
    // header
    outArray[0]["header"] = get_arr_std_msgs_Header(factory, msg->header);
    // STATE_MC
    outArray[0]["STATE_MC"] = factory.createScalar(static_cast<uint8_t>(msg->STATE_MC));
    // STATE_FW
    outArray[0]["STATE_FW"] = factory.createScalar(static_cast<uint8_t>(msg->STATE_FW));
    // state
