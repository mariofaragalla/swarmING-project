...
namespace ESCStatusItem {
  void copy_from_arr_std_msgs_Header(std_msgs::Header& val, const matlab::data::StructArray& arr);
  MDArray_T get_arr_std_msgs_Header(MDFactory_T& factory, const mavros_msgs::ESCStatusItem::_header_type& val);
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<mavros_msgs::ESCStatusItem>& msg, const matlab::data::StructArray arr) {
    try {
        //header
    ...
    try {
        //rpm
        const matlab::data::TypedArray<int32_t> rpm_arr = arr[0]["rpm"];
        msg->rpm = rpm_arr[0];
    } catch (matlab::data::InvalidFieldNameException&) {
  ...
  //----------------------------------------------------------------------------
  MAVROS_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const mavros_msgs::ESCStatusItem>& msg) {
    auto outArray = factory.createStructArray({1,1},{"header","rpm","voltage","current"});
    // header
    outArray[0]["header"] = get_arr_std_msgs_Header(factory, msg->header);
    // rpm
    outArray[0]["rpm"] = factory.createScalar(msg->rpm);
    // voltage
