...
data = struct();
[data.message_id, info.message_id] = ros.internal.ros.messages.ros.default_type('uint32',1);
[data.message_rate, info.message_rate] = ros.internal.ros.messages.ros.default_type('single',1);
