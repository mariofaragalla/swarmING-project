function [data, info] = waypointPushRequest
%WaypointPush gives an empty data for mavros_msgs/WaypointPushRequest
% Copyright 2019-2020 The MathWorks, Inc.
data = struct();
[data.start_index, info.start_index] = ros.internal.ros.messages.ros.default_type('uint16',1);
[data.waypoints, info.waypoints] = ros.internal.ros.custommessages.mavros_msgs.waypoint;
info.waypoints.MLdataType = 'struct';
info.waypoints.MaxLen = NaN;
info.waypoints.MinLen = 0;
data.waypoints = data.waypoints([],1);
info.MessageType = 'mavros_msgs/WaypointPushRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
