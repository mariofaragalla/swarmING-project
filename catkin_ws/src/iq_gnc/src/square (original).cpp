...
int main(int argc, char** argv)
{
	...
	init_publisher_subscriber(gnc_node);	//This function takes our ros node handle as an input and initializes subcribers that will collect the necessary information from our autopilot.
